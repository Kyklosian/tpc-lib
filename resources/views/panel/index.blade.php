...
<div class="content">
    <div class="btn-controls">
        <div class="btn-box-row row-fluid" >
            <div class="btn-box span12" style="background: #006400; ">
                    ...
                    <form class="form-horizontal row-fluid" id="findbookform">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <div class="span3">
                                    <a class="btn homepage-form-submit " style="background-color:  
                                    #006400; color:#fff"><i class="icon-search"></i> Search</a>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <form class="form-horizontal row-fluid" id="findissueform">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                ...
                                <a class="btn homepage-form-submit" style="background-color:  #006400; color:#fff"><i class="icon-search"></i> Search</a>
                            </div>
                        </div>
                    </form>
                </div>
