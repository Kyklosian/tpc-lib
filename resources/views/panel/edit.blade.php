...
<div class="content">
    <div class="module">
        ...
        <div class="module-body">
            <form class="form-horizontal row-fluid" action="{{ URL::route('book.edit') }}" method="GET">
                ...
                <div class="control-group">
                    <label class="control-label" for="basicinput">Call No.</label>
                    <div class="controls">
                        <textarea class="span8" id="description" data-form-field="description" placeholder="Enter the Call Numbers."></textarea>
                    </div>
                </div>
                ...
                <div class="control-group">
                    <div class="controls">
                        <button type="button" class="btn btn-inverse" id="addbooks">Submit</button>
                    </div>
                </div>
            </form>
        </div>
