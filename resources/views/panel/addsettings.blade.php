    ...
    <div class="module">
        ...
        <div class="row">
            <div class="module-body column">
                <h2 style="text-align:center; font-family:'Times New Roman', Times, serif">School Courses</h2>
                <form class="form-horizontal row-fluid">
                   
                    <div class="control-group">
                        <label class="control-label">Course</label>
                        <div class="controls">
                            <input type="text" id="branch" data-form-field="branch" placeholder="Enter course here..." class="span12">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <button type="button" class="btn btn-inverse" id="addBranch">Add Course</button>
                        </div>
                    </div>
                </form>
                <br>
                    ...
                    <tbody>
                      ...
                      <tr>
                           ...
                           <td><div class="btn btn-group">
                                ...
                                <a href="#" data-toggle="modal" data-target="#deleteBranch{{ $branch->id }}"><i class="btn btn-danger">Delete?</i></a>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('student.destroy', $branch->id) }}" method="Post">
                                        @csrf
                                        @method('Delete')
                                        <p>Are you sure you want to delete this ({{ $branch->branch }}) Course ? </p>
            ...
            <div class="module-body column">
                ...
                <form class="form-horizontal row-fluid">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="student_category" data-form-field="student_category" placeholder="Enter the category of the book" class="span12">
                            <input type="hidden"  data-form-field="token"  value="{{ csrf_token() }}">
                        </div>
                    </div>
                    <div class="control-group">
                ...
                <table class="table table-striped" style="margin-left: 30px">
                    ...
                    <tbody>
                      ...
                      <tr>
                           ...
                           <td><div class="btn btn-group">
                                <a href="#" data-toggle="modal" data-target="#deleteCategory{{ $student_category->cat_id }}"><i class="btn btn-danger">Delete?</i></a>
                            </div></td>
                      </tr>
                       <!-- Modal -->
