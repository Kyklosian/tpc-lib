					...
					<form class="form-horizontal row-fluid">
						...
						<div class="control-group">
							<div class="controls" id="search_book_button">
								<a class="btn btn-info pull-left">Search Book</a>
								<a href="{{ URL::route('account-sign-in') }}" type="button" class="btn btn-warning pull-right" style="color:#000000">Go Back!</a>								
							</div>						
						</div> 
						<div>
