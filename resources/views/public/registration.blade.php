			...
			<div class="module module-login span8 offset2">
				<form class="form-vertical" action="{{ URL::route('student-registration-post') }}" method="POST">
					...
					<div class="module-body">
						...
						<div class="control-group">
							<div class="controls row-fluid">
								...
								<input class="span4" type="number" placeholder="Year (example: 2021)" name="year" value="{{ Request::old('year') }}" /> 
					...
					<div class="module-foot">
						...
						<a href="{{ URL::route('account-sign-in') }}" type="button" class="btn btn-warning" style="color:#000000">Go Back!</a>
					</div>
				</form>
			</div>
		</div>
